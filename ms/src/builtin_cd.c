...
/*   Updated: 2023/10/08 11:21:17 by gabriela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Get cwd and store it in old_pwd. Check arguments. 
Check previous directory (-). Or move to the specified directory. 
If it fails, print error message. Return 0 for success or error. */
...
/* Loop through env variables, split it by =. If variaable
was found, break out of loop and update it. If not found, 
add it. Free memory.*/
